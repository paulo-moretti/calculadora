...
frame_corpo =Frame(janela, width=235, height=260, bg=cor4)
...
b_1.place(x=0, y=0)
b_2 = Button(frame_corpo, command = lambda: entrar_valores('%'),  text="%", width=5, height=2, bg=cor4, font=('Ivy 13 bold'), relief=RAISED )
b_2.place(x=118, y=0)
...
b_16 = Button(frame_corpo, command = lambda: entrar_valores('0'), text="0", width=5, height=2, bg=cor4, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
b_18 = Button(frame_corpo, command = calcular, text="=", width=11, height=2, bg=cor5, fg=cor2, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
